...
# Change Log
#     example:python NtripClientwithserialsupressedoutput.py -u evanbandit@gmail.com -p none -m 100000 -r 100 -v -k /dev/ttyACM0 -2 3.23.52.207 2101 BeehiveBeach
#     support functions:   
#         1.get source table;
